                            ...
                            <BarChart height={300} data={historyDataQuery.data} barCategoryGap={5}>
                                <defs>
                                    <linearGradient id='incomeBar' x1="0" y1="0" x2="0" y2="1">
                                        <stop stopColor='#10b981' offset={"0"} stopOpacity={"1"} />
                                        <stop stopColor='#10b981' offset={"1"} stopOpacity={"0"} />
                                    </linearGradient>
                                    
                                    <linearGradient id='expenseBar' x1="0" y1="0" x2="0" y2="1">
                                        <stop stopColor='#ef4444' offset={"0"} stopOpacity={"1"} />
                                        <stop stopColor='#ef4444' offset={"1"} stopOpacity={"0"} />
                                    </linearGradient>
                                </defs>
...
function TooltipRow({formatter, label, value, bgColor, textColor}: TooltipRowProps) {
