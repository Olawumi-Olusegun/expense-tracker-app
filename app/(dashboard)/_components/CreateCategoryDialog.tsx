            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
                    <FormField  
                     ...
                     render={({field}) => (
                        <FormItem>
                            <FormLabel>Name of Transaction</FormLabel>
                            <FormControl>
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <Popover>
                                    ...
                                    <PopoverContent className='w-full top-1/2 translate-y-1/2'>
                            ...
                            <FormDescription>This is how category will appear in the application </FormDescription>
                        </FormItem>
                     )}
                    />
