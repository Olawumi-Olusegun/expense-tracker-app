                ...
                <CardHeader>
                    <CardTitle className='flex items-center justify-between gap-2'>
                        <div className="flex items-center gap-2">
                            {type === "expense" 
                            ? <TrendingDown className='h-12 w-12 items-center rounded-lg bg-red-400/10 text-red-500 p-2  ' /> 
    ...
    return <>
     <div className="flex border-separate flex-col justify-between rounded-md border  ">
        ...
        <DeleteCategoryDialog category={category} trigger={
            <Button className='flex w-full border-separate items-center gap-2 rounded-none text-muted-foreground hover:bg-red-500/20' variant={"secondary"}>
