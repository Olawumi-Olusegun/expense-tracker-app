...
const columns: ColumnDef<TransactionHistoryRow>[] = [
    ...
    },
    {
        ...
        cell: ({row}) => {
            ...
            const formttedDate = date.toLocaleDateString("default", {
                timeZone: "UTC",
                year: "numeric",
                month: "2-digit",
                day: "2-digit"
    ...
    },
    {
        ...
        cell: ({row}) => (
            <p className='text-md rounded-lg bg-gray-400/5 p-2 text-center font-medium'>{row.original.formttedAmount}</p>
        )
    },
    {
        id: "actions",
...
function TransactionsTable({from, to}: Props) {
  ...
  return (
    <div className="w-full my-5">
        <div className="flex flex-wrap items-end justify-between gap-2 my-3">
                ...
                <Table>
                    ...
                    {table.getHeaderGroups().map((headerGroup) => (
                        ...
                        {headerGroup.headers.map((header) => {
                            return (
                            <TableHead key={header.id} className='font-bold capitalize'>
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align='end'>
                ...
                <DropdownMenuItem className='flex items-center gap-2' onSelect={() => {
                    ...
                    <TrashIcon className='h-4 w-4 mr-2 text-muted-foreground' />
                    Delete
                </DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
